...
| newrelic-pixie.apiKey | string | `""` | The [Pixie API key](https://docs.pixielabs.ai/reference/admin/api-keys/#create-an-api-key), generated by the New Relic guided installer |
...
| pixie-chart.deployKey | string | `""` | The [Pixie deploy key](https://docs.pixielabs.ai/reference/admin/deploy-keys/#create-a-deploy-key), generated by the New Relic guided installer |
...
| pixie-chart.useEtcdOperator | bool | `false` | Use `etcd` operator for [Pixie metadata storage](https://docs.pixielabs.ai/reference/admin/deploy-options/#select-metadata-storage-option) if persistent volumes are not available |
