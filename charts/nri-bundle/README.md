...
| [nr-ebpf-agent](https://github.com/newrelic/helm-charts/tree/master/charts/nr-ebpf-agent) |  | (Preview) Configures instances of the Nr eBPF agent that uses eBPF to automatically capture telemetry data without the need for manual instrumentation.              |
