...
| [nr-eAPM-agent](https://github.com/newrelic/helm-charts/tree/master/charts/nr-ebpf-agent)                                                     |  | Configures instances of the New Relic eAPM agent to automatically capture telemetry data without the need for manual instrumentation.                                |
