...
| global.provider | string | `nil` | The provider that hosts your cluster. Sub charts may have support for specific providers and will automatically set config constraints for them. |
