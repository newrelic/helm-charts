...
| `fluentBit.memBufLimit`                                    | Set the limit of the buffer size per monitored file. The value must be according to the [Unit Size](https://docs.fluentbit.io/manual/administration/configuring-fluent-bit/unit-sizes) specification.                                                                        | `7MB`                                |
| `fluentBit.skipLongLines`                         | When a monitored file reach it buffer capacity due to a very long line (Buffer_Max_Size), the default behavior is to stop monitoring that file.                                                                                                                              | `On`                                 |
| `fluentBit.refreshInterval`                         | The interval of refreshing the list of watched files in seconds.                                                                                                                                                                                                             | `10`                                 |
