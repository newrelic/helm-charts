...
| `initContainer.image.repository`                             | The container to pull for the persistence cleanup init container (used when `fluentBit.persistence.mode` is `persistentVolume`).                                                                                                                                                                                                                                                    | `busybox`                                                                       |
| `initContainer.image.registry`                                | The registry to pull the persistence cleanup init container image from.                                                                                                                                                                                                                                                                                                             | `nil`                                                                           |
| `initContainer.image.tag`                                    | The version of the persistence cleanup init container image to pull.                                                                                                                                                                                                                                                                                                                | `1.36`                                                                          |
| `initContainer.image.pullPolicy`                              | The pull policy for the persistence cleanup init container image.                                                                                                                                                                                                                                                                                                                    | `IfNotPresent`                                                                  |
