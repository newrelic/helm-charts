...
| `global.customSecretName` - `customSecretName`               | Name of the Secret object where the license key is stored. `endpoint` needs to be specified if both `customSecret*` values are specified.                                                                                                                                                                                                                                                                                                                            |                                                                                 |
| `global.customSecretLicenseKey` - `customSecretLicenseKey`   | Key in the Secret object where the license key is stored. `endpoint` needs to be specified if both `customSecret*` values are specified.                                                                                                                                                                                                                                                                                                                           |                                                                                 |
