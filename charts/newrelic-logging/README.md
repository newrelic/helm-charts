...
| `provider`                                                   | Sets common config options needed to install this chart on specific providers. Currently supports `GKE_AUTOPILOT` and `FARGATE`.                                                                                                                                                                                                                                                         |                                                                                 |
...
| `global.fedramp.enabled` - `fedramp.enabled`                 | If `true`, sends logs and metrics to New Relic's [FedRAMP-compliant endpoints](https://docs.newrelic.com/docs/security/security-privacy/compliance/fedramp-compliant-endpoints/) (`gov-log-api.newrelic.com` and `gov-metric-api.newrelic.com`). Requires a FedRAMP-authorized New Relic account. See [Enable FedRAMP-compliant endpoints](https://docs.newrelic.com/docs/kubernetes-pixie/kubernetes-integration/advanced-configuration/enable-fedramp-endpoints/).                                            | `false`                                                                         |
...
| `fluentBit.additionalEnvVariables`                           | Additional environmental variables for fluentbit pods (they can be Helm-templatized)                                                                                                                                                                                                                                                                                                 | `[]]`                                                                           |
...
| `fluentBit.persistence.initContainer.image.repository`       | On "persistentVolume" [persistence mode](#Fluent-Bit-persistence-modes), the container to pull for the init container that cleans up stale db files.                                                                                                                                                                                                                                | `busybox`                                                                       |
| `fluentBit.persistence.initContainer.image.registry`         | On "persistentVolume" [persistence mode](#Fluent-Bit-persistence-modes), the registry to pull the cleanup init container image from.                                                                                                                                                                                                                                                 | `nil`                                                                           |
| `fluentBit.persistence.initContainer.image.tag`               | On "persistentVolume" [persistence mode](#Fluent-Bit-persistence-modes), the version of the cleanup init container image to pull.                                                                                                                                                                                                                                                   | `1.36`                                                                          |
| `fluentBit.persistence.initContainer.image.pullPolicy`        | On "persistentVolume" [persistence mode](#Fluent-Bit-persistence-modes), the pull policy for the cleanup init container image.                                                                                                                                                                                                                                                       | `IfNotPresent`                                                                  |
...
| `fluentBit.fluentBitMetrics`                                 | Controls sending Fluent Bit metrics to New Relic. Allowed values: `none`, `basic`, `advanced`. `none`: No metrics sent. `basic`: Only build info metric sent. `advanced`: All metrics sent at 1 minute intervals. Default is `basic`.                                                                                                                                                | `basic`                                                                         |
...
| `livenessProbe.enabled`                                      | Enable or disable the liveness probe for the Fluent Bit pods.                                                                                                                                                                                                                                                                                                                        | `true`                                                                          |
...
| `livenessProbe.periodSeconds`                                | How often (in seconds) to perform the liveness probe.                                                                                                                                                                                                                                                                                                                                | `30`                                                                            |
| `livenessProbe.timeoutSeconds`                               | Number of seconds after which the liveness probe times out.                                                                                                                                                                                                                                                                                                                          | `5`                                                                             |
| `livenessProbe.failureThreshold`                             | When a liveness probe fails, Kubernetes will try `failureThreshold` times before giving up.                                                                                                                                                                                                                                                                                          | `3`                                                                             |
