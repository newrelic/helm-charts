...
| `config.infraAgentInjection.agentConfig.image.tag`                              | The infrastructure agent image tag for the sidecar container.                                                                                                                                                                                                                                                                               | `2.4.0-unprivileged`                                                                                 |
...
The default set of relations assigned to our job is shown below:
