...
{{- $defaultDaemonsetArgs := list "--config" "/config/daemonset-config.yaml" "--feature-gates" "receiver.kubeletstats.enableCPUUsageMetrics,metricsgeneration.MatchAttributes" }}
