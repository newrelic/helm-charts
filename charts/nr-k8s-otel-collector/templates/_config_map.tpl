...
{{- toYaml .Values.deployment.configMap.extraConfig.receivers | indent 6 -}}
{{- end -}}
{{- end -}}
{{- end -}}
{{- end -}}
...
{{- toYaml .Values.deployment.configMap.extraConfig.processors | indent 6 -}}
{{- end -}}
{{- end -}}
{{- end -}}
{{- end -}}
...
{{- toYaml .Values.deployment.configMap.extraConfig.exporters | indent 6 -}}
{{- end -}}
{{- end -}}
{{- end -}}
{{- end -}}
...
{{- toYaml .Values.deployment.configMap.extraConfig.connectors | indent 6 -}}
{{- end -}}
{{- end -}}
{{- end -}}
{{- end -}}
...
{{- toYaml .Values.deployment.configMap.extraConfig.pipelines | indent 8 -}}
{{- end -}}
{{- end -}}
{{- end -}}
{{- end -}}
...
{{- toYaml .Values.daemonset.configMap.extraConfig.receivers | indent 6 -}}
{{- end -}}
{{- end -}}
{{- end -}}
{{- end -}}
...
{{- toYaml .Values.daemonset.configMap.extraConfig.processors | indent 6 -}}
{{- end -}}
{{- end -}}
{{- end -}}
{{- end -}}
...
{{- toYaml .Values.daemonset.configMap.extraConfig.exporters | indent 6 -}}
{{- end -}}
{{- end -}}
{{- end -}}
{{- end -}}
...
{{- toYaml .Values.daemonset.configMap.extraConfig.connectors | indent 6 -}}
{{- end -}}
{{- end -}}
{{- end -}}
{{- end -}}
...
{{- toYaml .Values.daemonset.configMap.extraConfig.pipelines | indent 8 -}}
{{- end -}}
{{- end -}}
{{- end -}}
{{- end -}}
...
{{- toYaml .Values.processors | indent 6 -}}
{{- end -}}
{{- end -}}
