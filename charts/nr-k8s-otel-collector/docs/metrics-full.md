...
| Kubelet (Generated) | KubeletStats Receiver | node.cpu.usage.percentage  | Gauge | CPU usage as a percentage of the allocatable CPU on the node.|
| Kubelet (Generated) | KubeletStats Receiver | node.memory.usage.percentage   | Gauge | Memory usage as a percentage of the allocatable Memory on the node.  |
