...
| image.repository | string | `"otel/opentelemetry-collector-contrib"` | OTel collector image to be deployed. NRDOT is the default value but you can use your own collector as long it accomplish the following requirements  |
