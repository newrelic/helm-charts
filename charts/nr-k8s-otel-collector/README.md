...
Download and Update config [here](https://github.com/newrelic/helm-charts/tree/master/charts/nr-k8s-otel-collector/values.yaml#L5-L9) to add a cluster name, and New Relic Ingest - License key
