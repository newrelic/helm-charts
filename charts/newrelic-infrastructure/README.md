...
| `linuxEnabled`                 | Deploys the `DaemonSet` on all Linux nodes                                                                                                                                                                                                        | `true`                          |
| `windowsEnabled`               | Deploys the `DaemonSet` on all Windows nodes (see [Running on Windows](#running-on-windows))                                                                                                                                                      | `false`                         |
